---
name: ego-browser
description: Use for browser tasks that require the user's authenticated local browser session, shared cookies, or an explicitly requested Ego Browser workflow. Ego Browser gives agents an isolated task space while reusing local login state. Use Agent Browser instead for public pages, headless testing, and general automation.
metadata:
  version: "1.2.6"
  date: "2026-07-20"
---
