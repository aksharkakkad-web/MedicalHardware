...
## Corpus Check
- 577 files · ~599,388 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8053 nodes · 20818 edges · 435 communities (374 shown, 61 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 1650 edges (avg confidence: 0.93)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `465414f6`
...
4. `MonitoringIntelligenceEngine` - 91 edges
5. `seed_synthetic_story()` - 90 edges
...
Cohesion: 0.11
Nodes (36): list_clinic_events(), get, ClinicEventQueueResponse, ClinicEventStatus, field_validator, model_validator, StrEnum, EventQueuePosition (+28 more)

### Community 1 - "intelligence_mappers.py"
Cohesion: 0.08
Nodes (59): _alternative_data(), analysis_packet_from_row(), analysis_run_data(), analysis_run_from_data(), analysis_run_from_row(), analysis_run_to_row(), anomaly_from_row(), anomaly_to_row() (+51 more)

### Community 2 - "SourceItem"
Cohesion: 0.05
Nodes (100): days_ago(), get_date_confidence(), Determine confidence level for a date. Args: date_str: The date to check (YYYY-…, Calculate how many days before the reference date a date is. If reference_date…, Calculate recency score (0-100). 0 days before reference_date = 100, max_days…, recency_score(), analyze(), _build_signal() (+92 more)

### Community 3 - "timedelta"
Cohesion: 0.04
Nodes (28): FeedbackService, Pure operator commands over immutable resident-memory snapshots., ResidentMemoryService, EventAttentionPolicy, datetime, Synthetic recommendation policy; external notification delivery is out of scope., EventFlowTests, datetime (+20 more)
...
Cohesion: 0.04
Nodes (118): activate_telegram_for_explicit_sources(), activate_trustpilot_for_explicit_domain(), add_deep_research_source(), _annotate_and_record_discovery_queue(), apply_vs_competitor_routing(), _audience_register_for_run(), build_parser(), comparison_topic() (+110 more)
...
Cohesion: 0.04
Nodes (93): _candidate_text(), cluster_candidates(), _cluster_sort_key(), _cluster_uncertainty(), _merge_entity_clusters(), _mmr_representatives(), Candidate clustering and representative selection., Merge small clusters that cover the same story across different sources. The… (+85 more)
...
Cohesion: 0.13
Nodes (51): _assessment_payload(), _assignment_payload(), build_final_request(), build_recall_request(), build_specialist_request(), _canonical_json(), _case_payload(), final_response_schema() (+43 more)
...
### Community 15 - "get"
Cohesion: 0.11
Nodes (34): Convert Unix timestamp to YYYY-MM-DD string., timestamp_to_date(), get(), _clean_webvtt(), enrich_with_comments(), expand_tiktok_queries(), _extract_core_subject(), fetch_captions() (+26 more)
...
Cohesion: 0.06
Nodes (57): capture_failures(), _collect_secret_values(), DeadlineExceeded, _fixture_key(), fixture_module_capture(), _fixture_record(), _fixture_redactions(), _fixture_replay() (+49 more)
...
Cohesion: 0.16
Nodes (47): AuditLogRow, CalibrationSnapshotRow, EventActionRow, IdempotencyRecordRow, MonitoringSetupChangeRow, _action_body(), _headers(), parametrize (+39 more)
...
Cohesion: 0.03
Nodes (107): get_date_range(), Get the date range for the last N days. When as_of_date is provided, the range…, Re-run the nominate-stage casefold/entity-token collision rules over host-…, resolve_name_collisions(), _apply_hiring_signal_gate(), _best_community_comment(), _company_topic_likely(), _comparison_side_company_like() (+99 more)

### Community 30 - "MockMonitoringClient"
Cohesion: 0.09
Nodes (13): residentClient(), residentClient(), DemoScenarioState, MonitoringEventDetail, ResidentMemoryResponse, ResidentMonitoringSetupResponse, isStoredEvent(), isStoredMemory() (+5 more)

### Community 31 - "today.tsx"
Cohesion: 0.12
Nodes (15): destinations, HomeShell(), ArrowIcon(), CheckIcon(), HomeIcon(), IconProps, InfoIcon(), RoutineIcon() (+7 more)

### Community 32 - "QualityClass"
Cohesion: 0.11
Nodes (48): advance_episode(), AnomalyEpisode, AnomalyState, _baseline_for_evidence(), FeatureDeviation, _frame_deviations(), StrEnum, Transparent numerical anomaly gating with immutable episode revisions. (+40 more)

### Community 33 - "schema.py"
Cohesion: 0.11
Nodes (39): _agent_engagement(), _agent_generated_at(), _agent_summary(), candidate_from_dict(), candidate_primary_item(), cluster_from_dict(), discovery_report_from_dict(), discovery_topic_from_dict() (+31 more)
...
Cohesion: 0.05
Nodes (63): field_validator, _normalize_nonblank_tuple(), datetime, Product-facing device assignment and operational health concepts., _require_utc(), normalize_event_label(), coerce_enum(), Small validation helpers shared by in-memory domain boundaries. (+55 more)

### Community 36 - "providers.py"
Cohesion: 0.11
Nodes (25): extract_gemini_text(), extract_json(), extract_openai_text(), GeminiClient, mock_runtime(), OpenAIClient, OpenRouterClient, Any (+17 more)
...
Cohesion: 0.09
Nodes (43): _ensure_perplexity_in_plan(), Route a bounded paid Perplexity action through the whole topic. Deep Research…, build_discovery_plan(), build_drill_plan(), _build_prompt(), _comparison_entities(), _default_cluster_mode(), _default_freshness() (+35 more)

### Community 39 - "dependencies.py"
Cohesion: 0.08
Nodes (48): event_queue_query_service(), Depends, Session, setup_mutation_services(), SetupMutationServices, status_query_service(), change_resident_setup(), get_resident_awareness() (+40 more)
...
### Community 41 - "evaluate_search_quality.py"
Cohesion: 0.16
...
Cohesion: 0.12
Nodes (29): Observe failures locally WITHOUT hiding them from the enclosing sink.…, Submit a worker with the caller's failure-capture context., submit_with_context(), tee_failures(), _attr(), fetch_discovery_listings(), fetch_listings(), _fetch_one() (+21 more)
...
### Community 56 - "intelligence_repositories.py"
Cohesion: 0.07
Nodes (65): Tenant-scoped append-only repositories for monitoring intelligence., event_to_rows(), EventRowBundle, feedback_from_row(), feedback_to_row(), memory_from_rows(), memory_to_rows(), MemoryRowBundle (+57 more)
...
### Community 58 - "test_safety_paths.py"
Cohesion: 0.10
Nodes (57): DegradationKind, StrEnum, FallLikeState, StrEnum, align_observations(), datetime, Align one target window while preserving each source's evidence., FeatureValue (+49 more)
...
Cohesion: 0.15
Nodes (20): _cjk_tokens(), has_cjk(), CJK-aware tokenization for relevance scoring and near-duplicate detection. The…, True if the text contains any CJK / kana / hangul character., Tokenize mixed CJK / Latin text into a flat list of lowercased tokens. CJK runs…, segment(), dedupe_items(), get_ngrams() (+12 more)

### Community 62 - "setup_wizard.py"
Cohesion: 0.06
Nodes (53): _device_handle_path(), _digg_bin_candidate_paths(), _digg_bin_dir_hint(), _digg_off_path_binary(), _digg_on_path(), _existing_scrapecreators_key(), fetch_api_key(), get_setup_status_text() (+45 more)
...
Cohesion: 0.12
Nodes (25): device_query_service(), get_device_health(), list_devices(), Depends, get, Tenant-safe clinic reads for devices and operational health., DeviceAssignmentResponse, DeviceHealthDataAvailability (+17 more)
...
Cohesion: 0.04
Nodes (79): event_from_rows(), Deterministic, non-PHI synthetic product story for local development., SeededStory, calibration_from_rows(), calibration_to_row(), latest_setup_change_to_row(), monitoring_from_row(), monitoring_to_row() (+71 more)
...
Cohesion: 0.16
Nodes (15): Phase 2: extract entities from Phase 1 results, run targeted supplemental…, _run_supplemental_searches(), _compute_relevance(), judge_x_corpus(), promotable_handles(), prune_off_topic_items(), Any, X corpus judging for retrieve-judge-retry. No I/O: judges items already… (+7 more)

### Community 80 - "youtube_yt.py"
Cohesion: 0.08
Nodes (48): backfill_transcripts(), _clean_vtt(), extract_transcript_highlights(), fetch_transcript(), _fetch_transcript_direct(), _fetch_transcript_ytdlp(), _fetch_transcript_ytdlp_via_ssh(), fetch_transcripts_parallel() (+40 more)
...
Cohesion: 0.08
Nodes (33): outcomes, MonitoringClient, AddMemoryEntryInput, AttentionPriority, AwarenessDeliveryChoices, CalibrationDimensionId, CalibrationDimensionStatus, CalibrationStatus (+25 more)
...
Cohesion: 0.13
Nodes (51): advance_new_normal(), _baseline_from_values(), BaselinePolicy, build_feature_baseline(), FeatureBaseline, LearningGuard, _nearest_rank(), NewNormalCandidate (+43 more)
...
Cohesion: 0.12
Nodes (63): DispositionDecisionRow, MultiAgentAnalysisRow, MonitoringIntelligenceEngine, Stateful V1 lane over injected normalized frames; persistence is Task 8., PersistentMonitoringService, Session, Run the intelligence lane and append its exact evidence-bound outputs., Exercise every real contract/orchestration boundary without a paid API. (+55 more)
...
Cohesion: 0.07
Nodes (30): formattedTime(), LabData, LoadState, ScenarioLab(), renderLab(), toneMap, DemoScenarioContext, DemoScenarioProvider() (+22 more)

### Community 106 - "ProgressDisplay"
Cohesion: 0.06
Nodes (11): _build_nux_message(), ProgressDisplay, Build conversational NUX message with dynamic source status., Animated spinner for long-running operations., Progress display for research phases., Show web-only mode indicator., End web-only spinner., Show completion for web-only mode. (+3 more)
...
### Community 112 - "search_youtube"
Cohesion: 0.13
Nodes (19): _await_search_slot(), _claim_search_slot(), _fetch_video_comments_ytdlp(), _finish_search_slot(), is_ytdlp_installed(), Fetch top comments via yt-dlp, returning ``(comments, ran_cleanly)``. The bool…, Comments for a video via yt-dlp (free, keyless), or [] on any failure. Thin…, Return ``(cached, event, slot, is_leader)`` for search coalesce. - Cache hit:… (+11 more)
...
Cohesion: 0.09
Nodes (35): _documented_error(), FastAPI, register_error_handlers(), _status_code(), ErrorDetail, ErrorEnvelope, FeedbackRepository, IdempotencyConflictError (+27 more)
...
Cohesion: 0.15
Nodes (46): LLMClient, Protocol, _acknowledgment_scenario(), _active_monitoring(), _adoption_scenario(), _baseline(), _contradictory(), _engine() (+38 more)
...
Cohesion: 0.16
Nodes (28): Return the fixed staff action text for one controlled disposition., required_next_step(), Return one structured response for a bounded analysis stage., RoutingPlan, SpecialistAssessment, SpecialistAssignment, StageRequest, StageResponse (+20 more)

### Community 141 - "seed_synthetic_story"
Cohesion: 0.06
Nodes (73): _seed_second_resident(), Base, Durable product storage primitives., StoredEvent, DeviceHealthObservationRow, DeviceRoomAssignmentRow, DeviceRow, EventPriorityHistoryRow (+65 more)
...
Cohesion: 0.08
Nodes (52): health_from_row(), health_to_row(), datetime, Mappings between device domain records and durable rows., _stored_nonblank(), _stored_string_list(), StoredDevice, StoredDeviceAssignment (+44 more)
...
Cohesion: 0.14
Nodes (38): AnalysisRun, AnalysisState, AttributionScope, ConfidenceBand, FinalAnalysis, Possibility, StrEnum, Provider-neutral contracts for staged monitoring analysis. (+30 more)
...
Cohesion: 0.10
Nodes (34): HealthResponse, BaseModel, datetime, RequestContractModel, _require_utc(), AddMemoryEntryRequest, CorrectMemoryEntryRequest, MemoryEntryResponse (+26 more)
...
### Community 212 - "parse_polymarket_response"
Cohesion: 0.19
...
Cohesion: 0.16
Nodes (9): model_validator, _latest_memory_timestamp(), MemoryEntry, datetime, MemoryContextKind, _require_expected_memory_version(), validate_memory_context(), datetime (+1 more)
...
### Community 243 - "test_event_queue_api.py"
Cohesion: 0.33
...
### Community 271 - "reddit_arctic.py"
Cohesion: 0.26
...
Cohesion: 0.03
Nodes (155): _drill_cluster_text(), Resolve a 1-based cluster index or fuzzy title/entity description., resolve_drill_clusters(), get_register(), Return a named register, rejecting unsupported/free-form templates., _aggregate_engagement(), _amazon_footer_line(), _append_html_footer() (+147 more)
...
Cohesion: 0.09
Nodes (32): parse_as_of_date(), parse_date(), datetime, Date utilities for last30days skill., Parse a date string in various formats. Supports: YYYY-MM-DD, ISO 8601, Unix…, Validate and normalize an --as-of date. Args: as_of_date: Date string in YYYY-…, _extract_core_subject(), _log() (+24 more)

### Community 311 - "test_restart_durability.py"
Cohesion: 0.05
Nodes (73): _event_action(), main(), TestClient, Prove the complete Checkpoint D clinic Product API handoff story., _require(), run_checkpoint(), _seed_queue_events(), main() (+65 more)
...
### Community 325 - "_compute_text_similarity"
Cohesion: 0.33
...
### Community 326 - "_env_positive_float"
Cohesion: 0.33
...
### Community 329 - "enrich_with_comments"
Cohesion: 0.50
...
Cohesion: 0.03
Nodes (107): Inject AUTH_TOKEN/CT0 from .env config so Node subprocesses can use them., set_credentials(), Return (backups, comments) metadata for a source, or ([], None)., _sub_lanes_for(), _check_file_permissions(), config_exists(), ConfigLoadPolicy, cookie_extraction_browsers() (+99 more)
...
### Community 342 - "_extract_core_subject"
Cohesion: 0.50
Nodes (4): expand_youtube_queries(), _extract_core_subject(), Extract core subject from verbose query for YouTube search. NOTE: 'tips',…, Generate multiple YouTube search queries from a topic. Mirrors reddit.py's…
...
### Community 351 - "EventStore"
Cohesion: 0.17
Nodes (7): EventStore, MonitoringEvent, datetime, Compatibility view; the timestamp is the auditable source of truth., Latest timestamp across signals, priority changes, and actions., Groups related synthetic signals and enforces the caregiver lifecycle., Conservatively validate pre-record bridge keys without mutating history.
...
### Community 353 - "render_library_search"
Cohesion: 0.67
Nodes (3): _format_library_engagement(), Render dated FTS matches grouped by the topic run that produced them., render_library_search()
...
Cohesion: 0.09
Nodes (77): canonical_json(), _decision_data(), disposition_to_row(), DispositionRecord, interpretation_from_row(), interpretation_to_row(), StoredInterpretation, IntelligenceRepository (+69 more)
...
Cohesion: 0.18
Nodes (22): CampaignResult, _case_record(), _cases(), _live_cases(), Small-to-large orchestration for monitoring intelligence evaluation., _response_records(), _smoke_cases(), _balanced_bases() (+14 more)

### Community 365 - "_pick_ytdlp_vtt"
Cohesion: 0.67
Nodes (3): _pick_ytdlp_vtt(), Path, Return the best on-disk VTT match for video_id, preferring priority order.

### Community 368 - "token_overlap_relevance"
Cohesion: 0.06
Nodes (52): _date_to_unix(), enrich_top_stories(), fetch_discovery_listings(), _fetch_item_comments(), _flatten_query_for_algolia(), _log(), parse_hackernews_response(), Any (+44 more)
...
Cohesion: 0.17
Nodes (20): Protocol, StructuredAnalysisClient, multi_agent_evaluation_record(), MultiAgentExpectation, Deterministic case grading and zero-tolerance monitoring safety gates., calculate_multi_agent_metrics(), _case(), MultiAgentCampaignResult (+12 more)
...
### Community 382 - "v1/events.py"
Cohesion: 0.10
Nodes (64): alias, access_context(), database_session(), event_mutation_services(), EventMutationServices, Request, query_service(), request_idempotency_key() (+56 more)
...
Cohesion: 0.11
Nodes (26): classify_run_failure(), Map Bird's subprocess-only failure shapes to run outcome states., classify_failure(), Map a request failure to the doctor-aligned per-run vocabulary., _classify_source_failure(), _legacy_artifact_outcome(), _merge_reddit_items(), _outcome_artifact() (+18 more)
...
### Community 421 - "source_log"
Cohesion: 0.09
Nodes (29): debug(), is_debug(), Shared logging utilities for last30days skill., Log debug message to stderr (only when LAST30DAYS_DEBUG is set)., Log a source module message to stderr. Args: prefix: Source label (e.g.…, source_log(), _extract_core_subject(), _log() (+21 more)
...
- **Why does `get_date_range()` connect `pipeline.py` to `timedelta`, `trustpilot.py`, `extract_core_subject`, `resolve.py`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `post()` connect `http.py` to `search_feeds`, `watchlist.py`, `hosted.py`, `perplexity.py`, `source_log`, `jobs.py`, `intelligence_repositories.py`, `AuditLogRow`?**
...
- **Are the 25 inferred relationships involving `MonitoringIntelligenceEngine` (e.g. with `AnalysisState` and `MultiAgentAnalysisOrchestrator`) actually correct?**
  _`MonitoringIntelligenceEngine` has 25 INFERRED edges - model-reasoned connections that need verification._